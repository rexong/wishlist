...
from .services import (add_new_wish_to_db, edit_wish_in_db,
                       get_user_wishes_from_db, hide_wish_in_db,
                       remove_wish_from_db, unhide_wish_in_db)
...
def update_wishes(
    db: db_dependency, user: user_dependency, wish: schemas.WishEdit, id: int
):
